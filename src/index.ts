...
function convertTree(element: Element, specs: SVGNode, limit: number, treeProps: {
  [key: string]: string
}): GeoJsonFeature[] {
...
*/
    ...
    features = convertElementToGeoJsonFeature([svgElement], {...treeProps, class: specs.class, point: specs?.point})
  }
...
function convertElementToGeoJsonFeature(element: Node[], specprops: { [key: string]: any }): GeoJsonFeature[] {
